...
| 10 | [phase-10-release-acceptance.md](phase-10-release-acceptance.md) | Release acceptance & v1.0.0 publish | 9 | IN PROGRESS — v1.0.0 published; only the UNRAID drill (O4) remains |
...
| 17 | [phase-17-adaptive-dashboard.md](phase-17-adaptive-dashboard.md) | Adaptive dashboard: responsive shell, explorer browse, decision-first review | 16, 14 | NOT STARTED |
